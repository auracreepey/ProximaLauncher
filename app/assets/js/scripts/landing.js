...
function dlAsync(login = true){
    ...
    aEx.on('error', (err) => {
        ...
        showLaunchFailure('Une erreur est survenu', err.message || 'Essayez de relancer le téléchargement')
    })
        ...
        if(m.context === 'validate'){
            switch(m.data){
                case 'distribution':
                    ...
                    setLaunchDetails('Chargement de la distribution..')
                    break
                case 'version':
                ...
                case 'assets':
                    ...
                    setLaunchDetails('Vérification des libraries..')
                    break
                case 'libraries':
            ...
            switch(m.data){
                case 'download':
                    ...
                    setLaunchDetails('Préparation en cours..')
                    break
            }
        } else if(m.context === 'error'){
            switch(m.data){
                case 'download':
                    loggerLaunchSuite.error('Une erreur est survenu:', m.error)
...
function setNewsLoading(val){
    if(val){
        const nLStr = 'Actualisation en cours'
        let dotStr = '..'
